	...
	private void initialize() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent e) {
				...
				txtBuscadorTitulo.setBorder(BorderFactory.createCompoundBorder(txtBuscadorTitulo.getBorder(),
				...
				txtBuscadorGenero.setBorder(BorderFactory.createCompoundBorder(txtBuscadorGenero.getBorder(),
						BorderFactory.createEmptyBorder(0, 10, 0, 0)));
				...
				txtBuscadorLugar.setBorder(BorderFactory.createCompoundBorder(txtBuscadorLugar.getBorder(),
						BorderFactory.createEmptyBorder(0, 10, 0, 0)));
