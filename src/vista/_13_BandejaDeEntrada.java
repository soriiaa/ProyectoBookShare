...
public class _13_BandejaDeEntrada extends JFrame implements Vista {
	...
	private JLabel lblTituloBandeja;
	private JTextField textMensajeTitulos;
	...
	public _13_BandejaDeEntrada() {
		...
		btnBandejaDeEntrada.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				miControlador.cambiarVentana(13, 13);
			}
		});
		...
		btnNewButton.setBounds(574, 580, 315, 42);
		contentPane.add(btnNewButton);

		JButton btnMarcarMensajesComo = new JButton("Marcar mensajes como leidos");
		btnMarcarMensajesComo.setBackground(new Color(128, 255, 128));
		btnMarcarMensajesComo.setForeground(new Color(0, 0, 0));
		btnMarcarMensajesComo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				table.setForeground(new Color(128, 255, 128));
			}
		});
		btnMarcarMensajesComo.setFont(new Font("Tahoma", Font.BOLD, 12));
		btnMarcarMensajesComo.setBounds(249, 580, 315, 42);
		...
		textMensajeTitulos.setBounds(249, 75, 647, 29);
		contentPane.add(textMensajeTitulos);
		textMensajeTitulos.setColumns(10);
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{"Mensaje 1", "07/11/2021"},
				{"Mensaje 2", "09/11/2021"},
				{"Mensaje 3", "13/11/2021"},
				{"Mensaje 4", "17/11/2021"},
				{"Mensaje 5", "19/11/2021"},
				{"Mensaje 6", "24/11/2021"},
				{"Mensaje 7", "27/11/2021"},
				{"Mensaje 8", "30/11/2021"},
				{"Mensaje 9", "03/12/2021"},
				{"Mensaje 10", "5/12/2021"},
				{"Mensaje 11", "11/12/2021"},
			},
			new String[] {
				"Mensajes Recibidos", "Fecha de Entrega"
			}
		));
		table.setBounds(249, 104, 647, 466);
